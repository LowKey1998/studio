...
export const allMenuItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/admin/academics/student-enrollment', label: 'Student Enrollment Management', icon: UserPlus },
        { href: '/admin/timetable', label: 'Timetable', icon: Calendar },
        { href: '/admin/exams/timetable', label: 'Exam Timetable', icon: FileCheck },
        ...
        { href: '/admin/academics/lecturer-allocation', label: 'Lecturer Allocation', icon: UserPlus, notificationKey: 'unassignedCourses' },
    ...
    },
    {
      ...
      items: [
        ...
        { href: '/admin/finance/edit-approvals', label: 'Debit/Credit Notes', icon: ClipboardCheck },
    ...
    },
    {
      ...
      items: [
           ...
           { href: '/admin/hr/staff-applications', label: 'Staff Applications', icon: ClipboardPen },
    ...
    },
    {
      ...
      items: [
          ...
          { href: '/admin/facilities/accessories', label: 'Classroom Assets', icon: Monitor },
