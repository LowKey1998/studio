...
export default function StudentAttendanceDetailPage() {
    ...
    return (
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    <CardTitle className="font-headline text-2xl">Attendance Log: {course?.name}</CardTitle>
                    <CardDescription>A detailed record of your attendance for {course?.code}.</CardDescription>
                </CardHeader>
                <CardContent>
