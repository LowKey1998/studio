                        ...
                        <div className="grid gap-6 py-4 max-h-[70vh] overflow-y-auto pr-2">
                             <div>
                                ...
                                <div className="space-y-2 p-4 border rounded-md">
                                    <div className="space-y-1"><Label>Base Salary</Label><Input type="text" value={salaryComponents.baseSalary || ''} onChange={e => handleComponentChange('baseSalary', e.target.value)} /></div>
                                    <div className="space-y-1"><Label>Housing Allowance</Label><Input type="text" value={salaryComponents.housingAllowance || ''} onChange={e => handleComponentChange('housingAllowance', e.target.value)} /></div>
                                    <div className="space-y-1"><Label>Transport Allowance</Label><Input type="text" value={salaryComponents.transportAllowance || ''} onChange={e => handleComponentChange('transportAllowance', e.target.value)} /></div>
                                    <div className="space-y-1"><Label>Other Taxable Allowances</Label><Input type="text" value={salaryComponents.otherAllowances || ''} onChange={e => handleComponentChange('otherAllowances', e.target.value)} /></div>
                                </div>
                             </div>
                              <div>
                                ...
                                <div className="space-y-2 p-4 border rounded-md">
                                    {(salaryComponents.deductions || []).map((deduction, index) => (
                                        <div key={index} className="flex items-end gap-2">
                                            ...
                                            <div className="flex-grow space-y-1"><Label>Amount</Label><Input type="text" value={deduction.amount} onChange={e => handleDeductionChange(index, 'amount', e.target.value)} /></div>
