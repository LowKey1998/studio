...
import { AlertCircle, TrendingUp, Wallet, Info } from 'lucide-react';
...
export default function CashFlowPage() {
    ...
    React.useEffect(() => {
        if (!currentUser || !userData || allPaymentPlans.length === 0) {
            if (!loading && !currentUser) setLoading(false);
            return;
        };
        ...
        fetchAndProcessData();
    }, [currentUser, userData, allPaymentPlans, loading]);
