...
import { Loader2, PlusCircle, ExternalLink, Users, Calendar, Trash2, Eye } from 'lucide-react';
                                        ...
                                        <CardFooter className="flex justify-between">
                                            ...
                                            <Button variant="outline" asChild>
                                                <Link href={`/vacancies/${v.id}`} target="_blank">
                                                    <ExternalLink className="mr-2 h-4"/>View Public Page
                                                </Link>
                                            </Button>
                                        </CardFooter>
                                    </Card>
                ...
                <DialogContent className="max-w-4xl h-[90vh] flex flex-col">
                    ...
                    <div className="flex-1 overflow-y-auto pr-4">
                        <Table>
                            ...
                            <TableBody>
                            {selectedVacancy && selectedVacancy.applicants && Object.values(selectedVacancy.applicants).map(app => (
                                <TableRow key={app.id}>
                                    <TableCell>
